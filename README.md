...
[![codecov](https://codecov.io/gh/jammun/fast-api-template/branch/main/graph/badge.svg?token=fast-api-template_token_here)](https://codecov.io/gh/jammun/fast-api-template)
[![CI](https://github.com/jammun/fast-api-template/actions/workflows/main.yml/badge.svg)](https://github.com/jammun/fast-api-template/actions/workflows/main.yml)

Awesome fast_api_template created by jammun

## Install

from source
```bash
git clone https://github.com/jammun/fast-api-template fast_api_template
